...
ARG DOWNLOAD_VERSION=3.13.7
ARG DOWNLOAD_CHECKSUM=359aac972679cfd98d62af51ddaf80e674cab166e13c6a835e81759097f9ba2e
ARG DOWNLOAD_URL=https://files.teamspeak-services.com/releases/server/${DOWNLOAD_VERSION}/teamspeak3-server_linux_alpine-${DOWNLOAD_VERSION}.tar.bz2
